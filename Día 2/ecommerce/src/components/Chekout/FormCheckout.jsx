...
const FormCheckout = () => {
  ...
  <div className="grid grid-cols-1 gap-5 py-4">
    <div className="flex flex-col">
        ...
        <input type="text" className="form-input" id ="fullname"{...register("fullname",{required:true })} />
        {errors.fullname && <span className="text-red-500">Este campo es requerido</span>}
    </div>
    ...
    <div className="flex flex-col">
        ...
        <input type="text" className="form-input" id ="address" {...register("address",
            {required:"Este campo es requerido",
             minLength:{value:8,message:"Minimo 8 letras",},
    ...
    <button className="btn btn-black" type="submit">Validar Datos</button>
